...
export default function LandingPage() {
  ...
  return (
    <div className="flex min-h-[100dvh] flex-col relative">
      ...
      <div className="fixed inset-0 z-[1] bg-gradient-to-br from-background/30 via-background/20 to-background/30 backdrop-blur-[2px]" />
      
      <div className="relative z-10">
        <header
          className={`sticky top-0 z-50 w-full backdrop-blur-xl transition-all duration-300 ${isScrolled ? "bg-background/20 shadow-lg border-b border-white/10" : "bg-transparent"}`}
          style={{
        ...
        >
          <div className="container flex h-16 items-center justify-between">
            <div className="flex items-center gap-2 font-bold">
              <div className="size-8 rounded-lg bg-gradient-to-br from-primary to-primary/70 flex items-center justify-center text-primary-foreground backdrop-blur-sm">
                C8
              </div>
              <span>cre8tar</span>
            </div>
            ...
            <div className="hidden md:flex gap-4 items-center">
              <Button variant="ghost" size="icon" onClick={toggleTheme} className="rounded-full backdrop-blur-sm bg-white/10 hover:bg-white/20 border border-white/20">
              ...
              <Button className="rounded-full bg-gradient-to-r from-primary/80 to-primary backdrop-blur-sm border border-white/20 hover:from-primary hover:to-primary/90">
                Get Started
            ...
            <div className="flex items-center gap-4 md:hidden">
              ...
              <Button variant="ghost" size="icon" onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="backdrop-blur-sm bg-white/10 hover:bg-white/20 border border-white/20">
          ...
          {mobileMenuOpen && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -20 }}
              className="md:hidden absolute top-16 inset-x-0 backdrop-blur-xl border-b border-white/10"
              style={{
            ...
            >
              <div className="container py-4 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2 pt-2 border-t border-white/10">
                  ...
                  <Button className="rounded-full bg-gradient-to-r from-primary/80 to-primary backdrop-blur-sm border border-white/20">
                    Get Started
                    <ChevronRight className="ml-1 size-4" />
                  </Button>
                </div>
        ...
        <main className="flex-1">
          ...
          <section className="w-full py-20 md:py-32 lg:py-40 overflow-hidden">
            <div className="container px-4 md:px-6 relative">
              ...
              >
                <Badge className="mb-4 rounded-full px-4 py-1.5 text-sm font-medium backdrop-blur-sm bg-white/10 border border-white/20" variant="secondary">
                  Web4 Revolution
                </Badge>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button size="lg" className="rounded-full h-12 px-8 text-base bg-gradient-to-r from-primary/80 to-primary backdrop-blur-sm border border-white/20 hover:from-primary hover:to-primary/90">
                    Deploy Your AI Agent
                    <ArrowRight className="ml-2 size-4" />
                  </Button>
                  <Button size="lg" variant="outline" className="rounded-full h-12 px-8 text-base backdrop-blur-sm bg-white/10 border border-white/20 hover:bg-white/20">
                    Watch Demo
                  </Button>
                </div>
          ...
          {/* Logos Section */}
          <section className="w-full py-12 border-y border-white/10 backdrop-blur-xl" style={{
          ...
          <section id="features" className="w-full py-20 md:py-32">
            <div className="container px-4 md:px-6">
              ...
              >
                <Badge className="rounded-full px-4 py-1.5 text-sm font-medium backdrop-blur-sm bg-white/10 border border-white/20" variant="secondary">
                  Web4 Features
                </Badge>
              ...
              >
                {features.map((feature, i) => (
                  <motion.div key={i} variants={item}>
                    <Card className="h-full overflow-hidden border-white/10 backdrop-blur-xl transition-all hover:shadow-2xl hover:border-white/20" style={{
                      background: 'rgba(255, 255, 255, 0.05)',
                      backdropFilter: 'blur(20px)',
                      WebkitBackdropFilter: 'blur(20px)',
                      ...
                      <CardContent className="p-6 flex flex-col h-full">
                        <div className="size-10 rounded-full bg-primary/20 backdrop-blur-sm flex items-center justify-center text-primary mb-4 border border-primary/20">
                          {feature.icon}
                        </div>
          ...
          <section className="w-full py-20 md:py-32 relative overflow-hidden">
            ...
            <div className="container px-4 md:px-6 relative">
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 relative">
                <div className="hidden md:block absolute top-1/2 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-y-1/2 z-0"></div>
                ...
                {[
                  ...
                  >
                    <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-primary/80 to-primary backdrop-blur-sm text-primary-foreground text-xl font-bold shadow-lg border border-white/20">
                      {step.step}
                    </div>
